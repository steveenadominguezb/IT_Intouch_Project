                        ...
                        <ul class="navbar-nav">
                            ...
                            @else
                                @if (Auth::user()->privilege == 10001)
                                    <li class="nav-item">
                                        <a class="ms-5 h-75 nav-link text-light"
                                            href="{{ route('computers.list') }}">{{ __('Computers') }}</a>
                                    </li>
                                    <li class="nav-item">
                            ...
                            @else
                                <li class="nav-item dropdown">
                                    ...
                                    <div class="dropdown-menu dropdown-menu" aria-labelledby="navbarDropdown">
                                        ...
                                        @if (Auth::user()->privilege == 10001)
                                            <a class="dropdown-item" href="{{ route('register-employee.index') }}"
                                                onclick="">
                                                {{ __('Register Employee') }}
                                            </a>
                                            <a class="dropdown-item" href="{{ route('register-computer.index') }}"
                                                onclick="">
